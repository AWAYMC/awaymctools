...
import net.argania.core.commands.guild.admin.BanCommand;
import net.argania.core.commands.guild.admin.DeleteCommand;
import net.argania.core.commands.guild.admin.KickCommand;
import net.argania.core.commands.guild.admin.ReloadCommand;
import net.argania.core.commands.guild.admin.SetCommand;
import net.argania.core.commands.guild.admin.SetCuboidCommand;
import net.argania.core.commands.guild.admin.TeleportCommand;
import net.argania.core.commands.guild.admin.UnBanCommand;
